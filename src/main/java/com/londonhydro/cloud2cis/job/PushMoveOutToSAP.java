...
public class PushMoveOutToSAP extends SAPAbstractJob {
	...
	public void execute(List<MoveOutRequest> moveOutRequestList) throws Exception {
		...
		if (moveOutMap.isEmpty())
			...
			for (Map.Entry<Long, List<MoveOutRequest>> entry : moveOutMap.entrySet()) {
	...
	private Map<Long, List<MoveOutRequest>> createServerQueuesMap(List<MoveOutRequest> serverQueues) {
