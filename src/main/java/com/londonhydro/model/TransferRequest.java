...
import com.londonhydro.model.CustomerAddress;
 ...
 *
 */
public class TransferRequest extends BaseEntity<Long> implements Ideable<Long>, Serializable
{
    /**
	 * 
	 */
    ...
    @JsonProperty("moveInPremiseId")
    private String moveInPremiseId;
    @JsonProperty("moveInMailingAddress")
    private String moveInMailingAddress;
    @JsonProperty("moveInBuying")
    private String moveInBuying;
    @JsonProperty("moveInLawyerName")
    private String moveInLawyerName;
    @JsonProperty("moveInLawyerPhone")
    private String moveInLawyerPhone;
    @JsonProperty("moveInOwnerName")
    private String moveInOwnerName;
    @JsonProperty("moveInOwnerPhone")
    private String moveInOwnerPhone;
    @JsonProperty("moveInCustomerAddress")
    private CustomerAddress moveInCustomerAddress;
    @JsonProperty("moveInMailingAddressControl")
    private String moveInMailingAddressControl;
    
    public String getMoveInMailingAddressControl() {
		return moveInMailingAddressControl;
	}
	public void setMoveInMailingAddressControl(String moveInMailingAddressControl) {
		this.moveInMailingAddressControl = moveInMailingAddressControl;
	}
	...
	public String getMoveInPremiseId() {
		return moveInPremiseId;
	}
	public void setMoveInPremiseId(String moveInPremiseId) {
		this.moveInPremiseId = moveInPremiseId;
	}
	public String getMoveInMailingAddress() {
		return moveInMailingAddress;
	}
	public void setMoveInMailingAddress(String moveInMailingAddress) {
		this.moveInMailingAddress = moveInMailingAddress;
	}
	public String getMoveInBuying() {
		return moveInBuying;
	}
	public void setMoveInBuying(String moveInBuying) {
		this.moveInBuying = moveInBuying;
	}
	public String getMoveInLawyerName() {
		return moveInLawyerName;
	}
	public void setMoveInLawyerName(String moveInLawyerName) {
		this.moveInLawyerName = moveInLawyerName;
	}
	public String getMoveInLawyerPhone() {
		return moveInLawyerPhone;
	}
	public void setMoveInLawyerPhone(String moveInLawyerPhone) {
		this.moveInLawyerPhone = moveInLawyerPhone;
	}
	public String getMoveInOwnerName() {
		return moveInOwnerName;
	}
	public void setMoveInOwnerName(String moveInOwnerName) {
		this.moveInOwnerName = moveInOwnerName;
	}
	public String getMoveInOwnerPhone() {
		return moveInOwnerPhone;
	}
	public void setMoveInOwnerPhone(String moveInOwnerPhone) {
		this.moveInOwnerPhone = moveInOwnerPhone;
	}
	public CustomerAddress getMoveInCustomerAddress() {
		return moveInCustomerAddress;
	}
	public void setMoveInCustomerAddress(CustomerAddress moveInCustomerAddress) {
		this.moveInCustomerAddress = moveInCustomerAddress;
	}
    ...
    @Override public boolean equals(Object obj)
    {
        ...
        final TransferRequest other = (TransferRequest) obj;
